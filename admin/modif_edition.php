			...
			<div class="formulaire">
				...
				<form method="POST" action="#" enctype="multipart/form-data">
					...
					<fieldset>
						...
						<input type="tel" name="telephone1" placeholder="TÉLÉPHONE 1" value="<?php echo $Req_all_inf_edition_data['Telephone1']; ?>"> <br><br>

						<input type="tel" name="telephone2" placeholder="TÉLÉPHONE 2" value="<?php echo $Req_all_inf_edition_data['Telephone2']; ?>"> <br><br>

						<input type="tel" name="cellulaire" placeholder="CÉLLULAIRE" value="<?php echo $Req_all_inf_edition_data['Cellulaire']; ?>"> <br><br>
